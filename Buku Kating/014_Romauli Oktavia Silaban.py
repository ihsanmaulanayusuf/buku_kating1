...
if menu == "Kesekjenan":
    ...
    def baleg():
        gambar_urls = [
            ...
            "https://drive.google.com/uc?export=view&id=1pxO7NgXtSLLhEMlNhpoKKkFsuvJM3gET", #12
    ...
    def departemenpsda():
        gambar_urls = [
            ...
            "https://drive.google.com/uc?export=view&id=1vWkFZTxoZq9bDq3nE7yYMCUwxR_nY_ZM", #41
